...
در این نسخه، API تا آماده‌شدن PostgreSQL چند بار مهاجرت را تکرار می‌کند و رمز پیش‌فرض دیتابیس برای نصب تازه ثابت است تا خطای احراز هویت اولیه رخ ندهد. در ارتقا، فایل `.env` و داده‌های موجود عمداً حفظ می‌شوند.
