...
CREATE INDEX "PublishChannel_tenantId_type_idx" ON "PublishChannel"("tenantId","type");
CREATE INDEX "PublishArticle_tenantId_status_idx" ON "PublishArticle"("tenantId","status");
CREATE INDEX "PublishArticle_tenantId_scheduledAt_idx" ON "PublishArticle"("tenantId","scheduledAt");
